...
const urlsToCache = [
  './index.html',
  './manifest.json',
  '[https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.css](https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.css)',
  ...
  '[https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.9.2/proj4.js](https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.9.2/proj4.js)',
  '[https://cdnjs.cloudflare.com/ajax/libs/jsts/2.9.3/jsts.min.js](https://cdnjs.cloudflare.com/ajax/libs/jsts/2.9.3/jsts.min.js)',
  '[https://cdnjs.cloudflare.com/ajax/libs/shpjs/4.0.4/shp.min.js](https://cdnjs.cloudflare.com/ajax/libs/shpjs/4.0.4/shp.min.js)',
  '[https://cdnjs.cloudflare.com/ajax/libs/togeojson/0.16.0/togeojson.min.js](https://cdnjs.cloudflare.com/ajax/libs/togeojson/0.16.0/togeojson.min.js)',
...
self.addEventListener('fetch', event => {
  if (event.request.method !== 'GET' || event.request.url.includes('wfs')) return;
  event.respondWith(
